...
---------------------------------------------
all you have to do is to create the shortcut and name it Control Panel (or whatever
else you wish to name it to)then right click and click properties then click
change icon , and select the icon that matches your name, in this case , the control panel
icon.
